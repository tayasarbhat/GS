...
import { Search, ArrowUpDown, ChevronLeft, ChevronRight, Lock, Unlock } from 'lucide-react';
                      ...
                      {key === 'statusByCallCenter' ? (
                        <div className="flex items-center gap-2">
                          <select
                            ...
                            className={`flex-1 px-3 py-1.5 rounded-md border focus:ring-2 focus:ring-white/30 transition-colors ${
                              value === 'Open'
